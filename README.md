...
[中文说明](https://github.com/unix755/dccli/blob/main/README_chs.md)
...
- Download From https://github.com/unix755/dccli/releases

## Compile

```sh
# Download application source code
git clone https://github.com/unix755/dccli.git
...
- This program uses the `VESA` `DDC/CI` Display communication standard protocol which release in 1998 to exchange data
...
- You can use this tool to check which parameters that your monitor
  supported [ControlMyMonitor](https://www.nirsoft.net/utils/control_my_monitor.html)
